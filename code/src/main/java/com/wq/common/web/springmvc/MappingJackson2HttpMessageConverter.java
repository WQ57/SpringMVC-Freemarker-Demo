...
import com.wq.common.web.WebContext;
import com.wq.common.web.springmvc.editor.JsonDateFormat;
...
public class MappingJackson2HttpMessageConverter extends
	...
	protected void writeInternal(Object object, HttpOutputMessage outputMessage)
		...
		try {
			...
			// 对于jsonp的请求做特殊处理
			boolean isJSONP = !ObjectUtil.isEmpty(WebContext.getRequest()
					.getParameter(DEFAULT_CALLBACK));
			if (isJSONP) {
				WebContext.getResponse().setContentType(
						"application/x-javascript");
				jsonGenerator.writeRaw(WebContext.getRequest().getParameter(
						DEFAULT_CALLBACK)
						+ "(");
			}
	 ...
	 * {@link ObjectMapper#constructType(java.lang.reflect.Type)}, but this can
	 * be overridden in subclasses, to allow for custom generic collection
